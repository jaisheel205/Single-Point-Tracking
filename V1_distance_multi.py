...
while cap.isOpened():
    ...
    if success:
        for i, newbox in enumerate(boxes):
            ...
            if len(mid_points) == 2:
                ...
                #cv2.putText(frame, "P0 and P1: "+str(Distance), (10,30), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
                mid_points = []
    else:
        # Tracking failure
    ...
    for dist in dist_list:
        cv2.putText(frame, "P0 and P1: "+str(dist), (initial_x,initial_y), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
